...
用法：
    python3 tools/inject_carousel_kitchen.py            # 注入 / 更新全部 18 页
...
（18 页 × 25s ≈ 7.5 分钟一轮；扩展到 17 页时已从 30s 收到 25s，沿用。）
