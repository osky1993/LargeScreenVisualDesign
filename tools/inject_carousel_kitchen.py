...
用法：
    python3 tools/inject_carousel_kitchen.py            # 注入 / 更新全部 19 页
...
（19 页 × 25s ≈ 8 分钟一轮；扩展到 17 页时已从 30s 收到 25s，沿用。）
...
# 全链路流转页承上启下，插在物流运输之后（仓储→物流→全链路→门店，流向叙事最顺）。
PAGES = [
    ...
    ("大屏样板间-厨电全链路流转1920.html", "原料到用户的等距流转与正逆向物流"),
    ...
    ("大屏样板间-厨电智能物联运营1920.html", "在网设备、消息流与 OTA 拓扑"),
